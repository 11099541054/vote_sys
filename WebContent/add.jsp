...
<div id="voteManage" class="box">
	<h2>添加新投票</h2>
	<div class="content">
	<form method="post" action="VoteServlet?option=addVote" onsubmit="return check();">
			<dl>
				<dt>投票内容：</dt>
				<dd>
				   <input type="text" class="input-text" name="subjectTitle"/>
				</dd>
				<dt>投票类型：</dt>
				<dd>
		  		   <input type="radio" name="subjectType" checked="checked"  value="1"/>单选
				   <input type="radio" name="subjectType" value="2"/>多选
				</dd>
				<dt>投票选项：</dt>
				<dd id="voteoptions">
